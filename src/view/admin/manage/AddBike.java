...
//	}
	 ...
	 * @param addBike 
	 */
	public AddBike(AddBike addBike) {
		AddBike controller = new AddBike(this);
		...
		JButton btnAddBike = new JButton("Thêm");
		...
		btnAddBike.setBounds(100, 298, 136, 23);
		...
		btnAddBike.setBounds(365, 298, 142, 23);
		contentPane.add(btnAddBike);
